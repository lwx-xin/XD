 ...
 */
public class RecordLogJob extends QuartzJobBean {
     ...
     */
    public static final String jobName = "recordLog_job";
    public static final String jobGroupName = "recordLog_job_group";
    public static final String triggerName = "recordLog_trigger";
    public static final String triggerGroupName = "recordLog_trigger_group";
    public static final String cron = "0 14 22 * * ? *"; // 每天3点触发

    private LoggerRedis loggerRedis;
    ...
    private void loadBean() {
        if (loggerRedis == null) {
            loggerRedis = SpringUtil.getBean(LoggerRedis.class);
        }
    ...
    private void recordLog() {
        ...
        Map<String, List<String>> userLogsMap = loggerRedis.getLog();
...
//                    }
                    ...
                    if (loggerRedis.writeLog(logFilePath, logList)) {
