    ...
    o.prototype = {
        ...
        renderMenu: function() {
            ...
            if (! (e(n).length > 0)) {
                ...
                function(t, n) {
                    n.icon ? i += '<li class="ui-context-menu-item"><a href="javascript:void(0);"><i class="icon ' + n.icon + '" style="vertical-align: -4%;"></i><span>' + n.text + "</span></a></li>": i += '<li class="ui-context-menu-item"><a href="javascript:void(0);"><span>' + n.text + "</span></a></li>"
                }),
                i += "</ul>",
        ...
        eventBind: function() {
            var t = this;
            this.ele.on("click", function(n) {
                //n.preventDefault(),
				// if(e(".ul-context-menu").length == 0 || e(".ul-context-menu").is(":hidden")){
					t.renderMenu(),
					t.setPosition(n),
			...
			e(n).on("contextmenu", function() {
                e(".ul-context-menu").hide()
            });
        }
    },
    e.fn.clickMenu = function(t) {
        return new o(this, t),
        this
    }
