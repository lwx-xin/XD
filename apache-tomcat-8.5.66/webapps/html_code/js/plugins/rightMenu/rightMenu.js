    ...
    o.prototype = {
        ...
        renderMenu: function() {
            ...
            if (! (e(n).length > 0)) {
                ...
                function(t, n) {
                    n.icon ? i += '<li class="ui-context-menu-item"><a href="javascript:void(0);"><i class="icon ' + n.icon + '"></i><span>' + n.text + "</span></a></li>": i += '<li class="ui-context-menu-item"><a href="javascript:void(0);"><span>' + n.text + "</span></a></li>"
                }),
                i += "</ul>",
